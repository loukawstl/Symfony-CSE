 ...
 */
final class Version20230320102540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, text LONGTEXT NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, tariff VARCHAR(255) NOT NULL, type_of_offer VARCHAR(255) NOT NULL, nb_minimum_places INT NOT NULL, number_order_page INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
